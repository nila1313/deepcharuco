...
# New separate output folder for min4 pseudo labels
OUT_DIR = Path("../my_dataset/opencv_pseudolabels_raw_320_min4")
IMG_OUT = OUT_DIR / "images"
CSV_OUT = OUT_DIR / "keypoints"
VIS_OUT = OUT_DIR / "vis"

# Clear old min4 output to avoid stale files
if OUT_DIR.exists():
...
print("Minimum corners to keep:", MIN_CORNERS_TO_KEEP)
...
with open(summary_path, "w", newline="") as f:
    writer = csv.DictWriter(
        ...
        fieldnames=[
            "frame",
            "opencv_charuco_corners",
            "kept_for_pseudolabel"
        ]
    )
    writer.writeheader()
