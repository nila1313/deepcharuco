...
ckpt_dir = Path("./tb_logs/ckpts_deepcharuco_masked_pseudo_min6_aug")
...
for ckpt in ckpts:
    ...
    infer_img_dir = f"../my_dataset/inference_output_masked_pseudo_min6_aug_sweep/{safe_name}/images"
    infer_kpt_dir = f"../my_dataset/inference_output_masked_pseudo_min6_aug_sweep/{safe_name}/keypoints"
    comp_dir = f"../my_dataset/comparison_output_masked_pseudo_min6_aug_sweep/{safe_name}"
...
out_path = Path("../my_dataset/masked_pseudo_min6_aug_checkpoint_sweep_summary.csv")
