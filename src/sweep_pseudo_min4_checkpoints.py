...
ckpt_dir = Path("./tb_logs/ckpts_deepcharuco_pseudo_min4")
...
for ckpt in ckpts:
    ...
    infer_img_dir = f"../my_dataset/inference_output_pseudo_min4_sweep/{safe_name}/images"
    infer_kpt_dir = f"../my_dataset/inference_output_pseudo_min4_sweep/{safe_name}/keypoints"
    comp_dir = f"../my_dataset/comparison_output_pseudo_min4_sweep/{safe_name}"
...
out_path = Path("../my_dataset/pseudo_min4_checkpoint_sweep_summary.csv")
